...
For drag and drop, the common funtionality is abstracted into the v-draggable and v-droptarget directives , and specific drag drop scenarios can be implemented by implementing just the drag/drop handler function, and an optional check function which verifies that the operation is allowed -an example of this is the v-jse-drag-handler
